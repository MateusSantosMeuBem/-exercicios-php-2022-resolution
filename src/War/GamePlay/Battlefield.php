...
class Battlefield implements BattlefieldInterface {
    ...
    public function rollDice(CountryInterface $country, bool $isAtacking): array{
        ...
        /**
         * The number of this country will roll the dice.
         * 
         * @var int
         * 
        */        
        ...
        /**
         * This will generate an array with $dice_times if it's a defender,
         * $dice_times - 1 if it's a attacker random numbers from 1 to 6.
         * 
         * @var array
         * 
         */
        ...
        /**
         * Sort from the biggest to the smallest one
         * 
         */
        rsort($player_dices);
    ...
    public function computeBattle(CountryInterface $attackingCountry, array $attackingDice, CountryInterface $defendingCountry, array $defendingDice): void{
        /**
         * The each side number of troops.
         * 
         * @var int
         * @var int
         * 
        ...
        /**
         * Check which country has less troops
         * 
         */
